...
This directory is the contract surface of the project's config discipline — every knob a future-you might want to tune lives in YAML here, not in `.py` source.
...
- **Discipline**: all experiment knobs live in YAML here; `.py` files carry logic + the Pydantic schema only (ratified 2026-05-10)
