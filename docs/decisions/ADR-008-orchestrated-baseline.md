...
> **Erratum (2026-05-31, per ADR-031):** the Forward-pointer-resolution row above was corrected from an earlier "H1" slip to **H2** for the single-shot-vs-orchestrated comparison. §6 H1 is local-vs-cloud; H2 is the architecture comparison. The body's H2 usages were already correct.
