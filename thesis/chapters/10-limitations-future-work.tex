...
photographed documents score more than eleven points of mean per-invoice F$_1$ below
...
the correction is roughly that gap. The direction and magnitude are corroborated independently by
a multilingual parsing benchmark reporting an average 17.8\,\% drop for open-source parsers on
photographed documents \cite{mdpbench2026}.
...
(\S\ref{sec:results-heldout}) makes viable. The prototype of
