...
agreement and \ac{EU} data residency (Art.~28, 32 \ac{DSGVO} \cite{dsgvo32}).
Professional secrecy adds a second, separate requirement: under
\S203~\ac{StGB} \cite{stgb203} together with \S62a~\ac{StBerG} \cite{stberg62a},
any external service provider who gains access to client data must be bound to
...
B2B corpus \cite{berghaus2025}; that omission is the gap this thesis addresses,
...
\begin{itemize}
  \item an evaluation of recent \emph{specialised} open-weights local document
        ...
        class absent from the closest prior benchmark \cite{berghaus2025} ---
