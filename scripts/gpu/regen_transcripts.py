...
inline heredoc so the step is drivable as a single-line SSH command (some
IDE-integrated macOS terminals crash on embedded newlines in quoted args;
a script file is safe from any shell).
