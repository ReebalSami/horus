...
Tracked as a checklist in issue #12 (closed 2026-05-13). After acquisition closed,
the pilot (`#13`) ran against data already on disk; the previously-pending sub-issues
...
| `deferred` | Tier-3 dataset; not in scope. Re-evaluate if the evaluation scope grows. |
